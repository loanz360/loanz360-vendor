...
/**
 * API Route: BP Commission History
 * GET /api/partners/bp/commissions/history - Get commission history for BP
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // 4. Build query using actual schema columns from partner_leads table
    let query = supabase
      .from('partner_leads')
      .select(
        `
