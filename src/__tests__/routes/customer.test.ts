...
describe('POST /api/customer/verify-otp', () => {
})


describe('POST /api/customer/login-password', () => {
})


describe('POST /api/customer/login-otp', () => {
})


describe('POST /api/customer/set-password', () => {
})


describe('GET /api/customer/my-applications', () => {
})
