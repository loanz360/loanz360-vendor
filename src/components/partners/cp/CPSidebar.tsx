...
export function CPSidebar() {
  ...
  const displayUser = {
    id: user?.id || 'CP001',
    full_name: user?.full_name || 'Channel Partner',
    email: user?.email || '',
  ...
  const isActive = (href: string, exact = false) => {
    ...
    // This prevents /partners/cp from matching /partners/cp-other
  ...
  return (
    <div className="w-full frosted-sidebar pb-6 pt-[70px]">
      ...
      <GoldenProfileCard
        ...
        profileLink="/partners/cp/profile"
        currentPath={pathname}
      />

      {/* Navigation Menu - Sectioned Structure */}
      <div className="py-4">
        {loading ? (
          ...
          // Render sectioned menu if available
          ...
          // Fallback to flat menu if no sections
