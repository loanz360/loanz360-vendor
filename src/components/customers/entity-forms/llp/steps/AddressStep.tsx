...
export default function AddressStep({ data, errors, onUpdate }: LLPStepProps) {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Registered Office Address</h2>
        <p className="text-gray-400">Enter the registered office address as per MCA records</p>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Registered Office</h3>
            <p className="text-sm text-gray-500">As per Certificate of Incorporation</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            />
            {errors.registered_pincode && <p className="mt-1 text-sm text-red-400">{errors.registered_pincode}</p>}
          </div>
          ...
          <div>
            ...
            />
            {errors.registered_city && <p className="mt-1 text-sm text-red-400">{errors.registered_city}</p>}
          </div>
          ...
          <div>
            ...
            {errors.registered_state && <p className="mt-1 text-sm text-red-400">{errors.registered_state}</p>}
          </div>
        </div>
      </div>
    </div>
