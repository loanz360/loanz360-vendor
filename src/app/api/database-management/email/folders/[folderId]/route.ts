...
/**
 * GET /api/database-management/email/folders/[folderId]
...
export async function GET(
  ...
  try {
    ...
    apiLogger.error('Error fetching email folder', error)
    return NextResponse.json(
...
/**
 * PUT /api/database-management/email/folders/[folderId]
 * Update folder
 */
export async function PUT(
  ...
  try {
    ...
    apiLogger.error('Error updating email folder', error)
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    )
...
/**
 * DELETE /api/database-management/email/folders/[folderId]
 * Delete folder
 */
export async function DELETE(
  ...
  try {
    ...
    apiLogger.error('Error deleting email folder', error)
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    )
