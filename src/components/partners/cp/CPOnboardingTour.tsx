...
interface CPOnboardingTourProps {
  onComplete: () => void
}
...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description:
      'You\'re now a Channel Partner with access to our full lending network and exclusive commission rates.',
  ...
  },
  {
    ...
    description:
      'Submit and track loan applications from your Applications section. Manage the full lifecycle.',
    icon: <FileText className="w-10 h-10 text-[#FF6700]" />,
    hint: 'Find this in the sidebar menu',
  },
  {
    title: 'Lender Network',
    description:
      'Access our extensive lender network. View mapped lenders and explore new partnerships.',
    icon: <Building2 className="w-10 h-10 text-[#FF6700]" />,
    hint: 'Check the Lender Network section',
  },
  {
    title: 'Track Payouts',
    description:
      'Monitor your commission payouts, view payout grid rates, and raise disputes if needed.',
  ...
  },
  {
    title: 'Get Started!',
    description:
      'Submit your first application or explore the payout grid to see commission rates!',
    icon: <Sparkles className="w-10 h-10 text-[#FF6700]" />,
    hint: 'Submit your first application now',
  },
]

const STORAGE_KEY = 'cp_onboarding_complete'

export default function CPOnboardingTour({ onComplete }: CPOnboardingTourProps) {
