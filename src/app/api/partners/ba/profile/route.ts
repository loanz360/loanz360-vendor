...
/**
 * GET /api/partners/ba/profile
 * Fetches BA partner profile
 */
export async function GET(request: NextRequest) {
  try {
    ...
    apiLogger.error('Error in GET /api/partners/ba/profile', error)
    return NextResponse.json(
...
/**
 * PUT /api/partners/ba/profile
 * Updates BA partner profile
 */
export async function PUT(request: NextRequest) {
  try {
    ...
    if (error) {
      apiLogger.error('Error upserting BA profile', error)
      return NextResponse.json(
        {
          success: false,
    ...
    apiLogger.error('Error in PUT /api/partners/ba/profile', error)
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    )
