...
/**
 * API Route: BA Commission Summary
 * GET /api/partners/ba/commissions/summary - Get commission summary for BA
 *
...
export async function GET(request: NextRequest) {
  try {
    ...
    // 3. Query commission summary directly from leads table
    // Using actual schema columns: estimated_commission, actual_commission, commission_paid, status
