...
interface BAOnboardingTourProps {
  onComplete: () => void
}
...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description:
      'You are now part of India\'s most advanced loan distribution network. This quick tour will help you get started as a Business Associate.',
  ...
  },
  {
    title: 'Submit Leads',
    description:
      'Use the sidebar navigation to submit new loan leads. You can add customer details, select loan types, and track every lead from submission to disbursement.',
  ...
  },
  {
    ...
    description:
      'Your dashboard shows real-time stats — total leads, conversion rates, pending applications, and more. Stay on top of your performance at a glance.',
  ...
  },
  {
    ...
    description:
      'Head to the Finance section to view your earnings, pending payouts, and commission breakdown per loan product. Transparent tracking for every rupee earned.',
    icon: <IndianRupee className="w-10 h-10 text-[#FF6700]" />,
    hint: 'Check the Finance section in the sidebar',
  },
  {
    title: 'Get Started!',
    description:
      'You\'re all set! Submit your first lead and start earning commissions. Our support team is always here to help if you need anything.',
    icon: <Sparkles className="w-10 h-10 text-[#FF6700]" />,
    hint: 'Submit your first lead now',
  },
]

const STORAGE_KEY = 'ba_onboarding_complete'

export default function BAOnboardingTour({ onComplete }: BAOnboardingTourProps) {
