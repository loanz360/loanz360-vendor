/**
 * API Route: Individual BP Lead Management
 * GET /api/partners/bp/leads/[id] - Get lead details
 * PUT /api/partners/bp/leads/[id] - Update lead
 * DELETE /api/partners/bp/leads/[id] - Delete lead
 *
 * Rate Limits:
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    apiLogger.error('Get lead error', error instanceof Error ? error : undefined)
    return NextResponse.json(
      {
        success: false,
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      data: updatedLead as UpdateLeadResponse['data'],
    } as UpdateLeadResponse)
  } catch (error: unknown) {
    apiLogger.error('Update lead error', error instanceof Error ? error : undefined)
    return NextResponse.json(
      {
        success: false,
        error: error instanceof Error ? error.message : 'Internal server error',
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    apiLogger.error('Delete lead error', error instanceof Error ? error : undefined)
    return NextResponse.json(
      {
        success: false,
        error: error instanceof Error ? error.message : 'Internal server error',
